...
Le terme de comptabilité peut être trompeur, car la comptabilité nationale est très différente de la comptabilité en entreprise: - Le comptable d'une entreprise dispose de registres avec une information complète sur les données de l'entreprise - Cela n'est pas possible pour la comptabilité nationale (impliquerait une information exhaustive sur des millions d'individus et d'entreprises) - La comptabilité nationale repose donc fortement sur une information partielle qui nécessite des approximations, des estimations et des révisions
