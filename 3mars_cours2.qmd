...
Dans notre modèle $log(C) = \beta_0 + \beta_1 year + e_i$, et pour les séries temporelles non-stationnaire de manière générale, $e_i$ représente l'écart de $C$ par rapport à sa tendance de long-terme.
